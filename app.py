...
texts = {
    "العربية": {
        ...
        "first_year_eggs": "بيض السنة الأولى",
        "second_year_eggs": "بيض السنة الثانية", 
        "first_year_days": "أيام السنة الأولى",
        "second_year_days": "أيام السنة الثانية",
    ...
    "English": {
        ...
        "first_year_eggs": "First Year Eggs",
        "second_year_eggs": "Second Year Eggs",
        "first_year_days": "First Year Days", 
        "second_year_days": "Second Year Days",
    ...
    "Română": {
        ...
        "first_year_eggs": "Ouă Primul An",
        "second_year_eggs": "Ouă Al Doilea An",
        "first_year_days": "Zile Primul An",
        "second_year_days": "Zile Al Doilea An", 
        "first_year_profit": "Profit Primul An",
    ...
    if st.button(texts[language]["calculate_profits"], type="primary"):
        try:
            ...
            if eggs_value is None or days_value is None:
                ...
                first_year_eggs = min(eggs_value, 260)
                second_year_eggs = max(0, eggs_value - 260)
    ...
    if st.button(texts[language]["add_chicken"], type="primary"):
        try:
            ...
            if egg_rate is None or active_days is None:
                ...
                first_year_eggs = min(egg_rate, 260)
                second_year_eggs = max(0, egg_rate - 260)
            ...
            detailed_df = pd.DataFrame([
                {
                    ...
                    "📊 الربح مع البيع": format_decimal(chicken["profit_with_sale"]) if chicken["eggs"] >= 260 and chicken["profit_with_sale"] > 0 else "-"
                }
